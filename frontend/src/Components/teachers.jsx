        ...
        <div class="container">
            <div class="row">  
                <div class="col-lg-4 col-md-6">
                  <div class="card mb-5"> 
                    <img src="assets2/images/teacher/slim2.jpg" alt="image"/> 
                    <div class="card-body teacher-content p-25">  
                      <h4 class="card-title mb-1"><a href="teacherdetails">Slim Abdennader</a></h4>
                      <span class="primary-color d-block mb-4">Computer Science</span>
                ...
                <div class="col-lg-4 col-md-6">
                  <div class="card mb-5"> 
                    <img src="assets2/images/teacher/teacher-member2.jpg" alt="image"/> 
                    <div class="card-body teacher-content p-25">  
                      <h4 class="card-title mb-1"><a href="teacherdetails">Cameron Brown</a></h4>
                ...
                <div class="col-lg-4 col-md-6"> 
                  <div class="card mb-5"> 
                    <img src="assets2/images/teacher/mervat2.jpg" alt="image"/> 
                    <div class="card-body teacher-content p-25">  
                      <h4 class="card-title mb-1"><a href="teacherdetails">Mervat Aboelkhair</a></h4>
                      <span class="primary-color d-block mb-4">Data Base</span>
                      <p class="card-text">We’re a philosophical bunch here at School site and we have thought long and hard about.</p> 
                      <ul class="list-inline">
                      <li><a href="https://youtu.be/z4tOlwuHEZI"><i class="fa fa-facebook"></i></a></li>
                                <li><a href="https://youtu.be/kXhBKjDKF84"><i class="fa fa-twitter"></i></a></li>
                ...
                <div class="col-lg-4 col-md-6"> 
                  <div class="card mb-5"> 
                    <img src="assets2/images/teacher/haythim2.jpg" alt="image"/> 
                    <div class="card-body teacher-content p-25">  
                      <h4 class="card-title mb-1"><a href="teacherdetails">Haythim O Ismaial</a></h4>
                      <span class="primary-color d-block mb-4">Theroy Of Competition</span>
                      <p class="card-text">We’re a philosophical bunch here at School site and we have thought long and hard about.</p> 
                      <ul class="list-inline">
                      <li><a href="https://youtu.be/z4tOlwuHEZI"><i class="fa fa-facebook"></i></a></li>
                                <li><a href="https://youtu.be/kXhBKjDKF84"><i class="fa fa-twitter"></i></a></li>
                ...
                <div class="col-lg-4 col-md-6"> 
                  <div class="card mb-5"> 
                    <img src="assets2/images/teacher/amr2.jpg" alt="image"/> 
                    <div class="card-body teacher-content p-25">  
                      <h4 class="card-title mb-1"><a href="teacherdetails">Amr ElMougy</a></h4>
                      <span class="primary-color d-block mb-3">Networks</span>
                      <p class="card-text">We’re a philosophical bunch here at School site and we have thought long and hard about.</p> 
                      <ul class="list-inline">
                      <li><a href="https://youtu.be/z4tOlwuHEZI"><i class="fa fa-facebook"></i></a></li>
                                <li><a href="https://youtu.be/kXhBKjDKF84"><i class="fa fa-twitter"></i></a></li>
                ...
                <div class="col-lg-4 col-md-6"> 
                  <div class="card mb-5"> 
                    <img src="assets2/images/teacher/teacher-member6.jpg" alt="image"/> 
                    <div class="card-body teacher-content p-25">  
                      <h4 class="card-title mb-1"><a href="teacherdetails">Patrick Garner Dony</a></h4>
