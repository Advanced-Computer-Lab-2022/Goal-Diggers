...
function Instructorprofile(handleCountry) {
  const [myCourses, setMyCourses] = useState({ instructorCourses: false });
  const [editprofile, seteditprofile] = useState({ editinstructorprofile: false });
                      ...
                      <ul id="m_menu_active">
                        ...
                        <li>
                          ...
                          <ul className="submenu">
                            <li className="active">
                              <a href="/instructorprofile">View Profile</a>
                              <h1
      ...
      <div className="wrapper">
        <div className="sidebar">
          ...
          <ul>
            ...
            <li>
              <a onClick={editinstructorprofile}>
                <span className="icon">
