            ...
            <div class="col-lg-8">
              <div class="teacher-contenttchd-content pl-5 pb-5">
                ...
                <ul class="list-inline mt-4 mb-4">
                  ...
                  <li>
                    <a href="https://youtu.be/fLUowJ1x3yc">
          ...
          <div class="row">
            <div class="col-md-6">
              <div class="section-title">
                <h3>
                  {inst.username} <span class="primary-color">other </span>{" "}
                  courses
                </h3>
              </div>
            </div>
            ...
            <div class="row">
              <div class="col-lg-3 col-md-6 col-sm-6">
                <div class="w-cs-single">
                  ...
                  <div class="fix">
                    <p class="mb-0">
                      <a href="coursedetails">Ui / Ux Design</a>
                    </p>
                    <span>
                      <i class="fa fa-clock-o"></i> AUGUST 6, 2022
                    </span>
                  </div>
                </div>
              </div>
              <div class="col-lg-3 col-md-6 col-sm-6">
                <div class="w-cs-single">
                  ...
                  <div class="fix">
                    <p class="mb-0">
                      <a href="coursedetails">Learn Java</a>
                    </p>
                    <span>
                      <i class="fa fa-clock-o"></i> AUGUST 6, 2021
                    </span>
                  </div>
                </div>
              </div>
              <div class="col-lg-3 col-md-6 col-sm-6">
                <div class="w-cs-single">
                  ...
                  <div class="fix">
                    <p class="mb-0">
                      <a href="coursedetails">C++</a>
                    </p>
                    <span>
                      <i class="fa fa-clock-o"></i> AUGUST 6, 2020
                    </span>
                  </div>
                </div>
              </div>
              <div class="col-lg-3 col-md-6 col-sm-6">
                <div class="w-cs-single">
                  ...
                  <div class="fix">
                    <p class="mb-0">
                      <a href="coursedetails">Seo</a>
                    </p>
                    <span>
                      <i class="fa fa-clock-o"></i> AUGUST 6, 2019
                    </span>
                  </div>
                </div>
              </div>
