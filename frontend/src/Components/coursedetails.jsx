              ...
              {type === "rule" && (
                <>
                  <div className="login-box">
                    <form>
                      <a href="/coursedetails">Request the Course</a>
                    </form>
                  </div>
                </>
              )}
                  ...
                  <div class="col-lg-8 col-md-8">
                    <div class="course-details">
                      <div class="cs-thumb mb-5">
                        ...
                        <span class="cs-price">
                          {course.discount &&
                          new Date(course.discount.start) <= Date.now() &&
                          new Date(course.discount.end) >= Date.now() ? (
                            <React.Fragment>
                    ...
                    <div class="comment-area">
                      <h4 class="comment-title">
                        Comments <span>({course.reviews.length})</span>
                      </h4>
                      ...
                      <div class="widget widget-instructor">
                        ...
                        <div class="instructor">
                          <div class="post-author-info">
                            <div class="thumb">
                              <img
                                src="/assets2/images/author/cs-post-author1.jpg"
                                alt="image"
                              />
                            </div>
                            <h5 >
                              ...
                              <React.Fragment>
                                <div class="w-cs-single">
                                  ...
                                  <div class="fix">
                                    ...
                                    <span>
                                      <i class="fa fa-clock-o"></i> AUGUST 6,
                                      2023
                                    </span>
                                  </div>
                                </div>
