...
<div class="header-bottom">
    ...
    <div class="crumbs-area">
        <div class="container">
            <div class="crumb-content"><fieldset class="field-container mb-5">
                    <form action="/search">
                ...
                <div class="col-lg-6">
                    <div class="about-left-content">
                        <div class="section-title">
                            ...
                            <h2>Welcome to</h2><h2><span>Our </span> <span class="primary-color">Company</span></h2> 
                        </div>
    ...
    <div class="take-toure-area ptb--120">
        <div class="container">
            <div class="row">
                ...
                <h4>Take a <span>Tour in Company</span></h4>
            </div>
                </div>
            </div>
